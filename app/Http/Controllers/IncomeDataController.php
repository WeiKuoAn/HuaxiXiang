...
class IncomeDataController extends Controller
{
    public function index(Request $request){
        ...
        return view('incomes_data')->with('datas',$datas)->with('request',$request)->with('incomes',$incomes)->with('users',$users)->with('condition',$condition)
    ...
    public function suject_update($id, Request $request){
        $plan = IncomeData::where('id',$id)->first();
