                ...
                <div class="row">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="row g-3" action="{{ route('editUserWork.data',$work->id) }}" method="POST">
                                @csrf
                                <div class="row mb-3 mt-2">
                                    <label for="name" class="col-sm-2 col-form-label">上班時間</label>
                                    <div class="col-sm-10">
                                        <input type="datetime" class="form-control" id="name" name="worktime" value="{{ $work->worktime }}">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="username" class="col-sm-2 col-form-label">下班時間</label>
                                    <div class="col-sm-10">
                                        <input type="datetime" class="form-control" id="username" name="dutytime" value="{{ $work->dutytime }}">
                                    </div>
                                </div>
