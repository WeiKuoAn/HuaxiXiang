        ...
        <div class="row">
            ...
            <div class="col-lg-8 mx-auto">
                <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">編輯-其他收入Key單</h5>

                            <!-- General Form Elements -->
                            <form class="row g-3" action="{{ route('edit-income.data',$income->id) }}" method="POST">
                                @csrf
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="col-sm-12">
                                        <select class="form-select" aria-label="Default select example" name="income_id">
                                            ...
                                            <option value="{{ $income_name->id }}" @if($income_name->id == $income->income_id) selected @endif>{{ $income_name->name  }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" id="price" name="price" value="{{ $income->price }}">
                                </div>
                                <div class="col-12">
                                    <label for="inputNanme4" class="form-label">備註</label>
                                    <textarea class="form-control" id="floatingTextarea" name="comment" rows="8">{{ $income->comment }}</textarea>
                                </div>
