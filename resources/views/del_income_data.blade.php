        ...
        <div class="row">
            ...
            <div class="col-lg-8 mx-auto">
                <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">刪除-其他收入Key單</h5>

                            <!-- General Form Elements -->
                            <form class="row g-3" action="{{ route('del-income.data',$income->id) }}" method="POST">
                                @csrf
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="col-sm-12">
                                        <select class="form-select" aria-label="Default select example" name="income_id">
                                            ...
                                            <option value="{{ $income_name->id }}">{{ $income_name->name  }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
