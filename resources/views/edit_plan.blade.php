        ...
        <div class="row">
            ...
            <div class="col-lg-8 mx-auto">
                <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">編輯方案資料</h5>

                            <!-- General Form Elements -->
                            <form class="row g-3" action="{{ route('edit-plan.data',$plan->id) }}" method="POST">
                                @csrf
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="col-sm-12">
                                        <select class="form-select" aria-label="Default select example" name="status">
                                            <option value="up" @if($plan->status == 'up') selected @endif>上架</option>
                                            <option value="down" @if($plan->status == 'down') selected @endif>下架</option>
                                        </select>
                                    </div>
                                </div>
