        ...
        <div class="row">
            ...
            <div class="col-lg-8 mx-auto">
                <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">編輯客戶群組</h5>

                            <!-- General Form Elements -->
                            <form class="row g-3" action="{{ route('edit-customer.group.data',$data->id) }}" method="POST">
                                @csrf
                                <div class="col-12">
                                    <label for="inputNanme4" class="form-label">群組名稱</label>
