        ...
        <div class="row">
            ...
            <div class="col-lg-8 mx-auto">
                <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">編輯來源資料</h5>

                            <!-- General Form Elements -->
                            <form class="row g-3" action="{{ route('edit-source.data',$source->id) }}" method="POST">
                                @csrf
                                <div class="col-12">
                                    <label for="inputNanme4" class="form-label">來源代號</label>
                                    <input type="text" class="form-control" id="code" name="code" value="{{ $source->code }}" readonly>
                                </div>
                                <div class="col-12">
