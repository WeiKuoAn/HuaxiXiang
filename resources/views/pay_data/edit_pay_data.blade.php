                                ...
                                <table id="cart" class="table table-striped">
                                    ...
                                    @foreach($data->pay_items as $key=>$item)
                                        <tr id="row-{{ $key }}">
                                            ...
                                            <td>
                                                <input list="vender_number_list_q" class="form-control" id="vendor-{{ $key }}" name="vender_id[]" placeholder="請輸入統編號碼" @if(isset($item->vender_data)) value="{{ $item->vender_data->name }}" @else value="{{ $item->invoice_number }}" @endif>
